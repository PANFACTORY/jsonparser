...
TEST(JsonParserTest, NodeHappyTest2) {
    ...
    JsonParser::Node *child1 = new JsonParser::Node("name"),
                     *child2 = new JsonParser::Node("age");
...
TEST(JsonParserTest, NodeHappyTest3) {
    JsonParser::Node root("");
    JsonParser::Node *child1 = new JsonParser::Node(""),
                     *child2 = new JsonParser::Node("");
...
TEST(JsonParserTest, NodeHappyTest8) {
    ...
    JsonParser::Node *child11 = new JsonParser::Node("user_id"),
                     *child12 = new JsonParser::Node("user_name");
    ...
    ASSERT_EQ(
        root.Str(),
        R"({"user_info":{"user_id":"A1234567","user_name":"Yamada Taro"}})");
}

TEST(JsonParserTest, NodeHappyTest9) {
    JsonParser::Node root("");
    JsonParser::Node *child1 = new JsonParser::Node("color_list");
    JsonParser::Node *child11 = new JsonParser::Node(""),
                     *child12 = new JsonParser::Node(""),
                     *child13 = new JsonParser::Node("");
    ...
    JsonParser::Node *child21 = new JsonParser::Node(""),
                     *child22 = new JsonParser::Node(""),
                     *child23 = new JsonParser::Node("");
    ...
    JsonParser::Node *child31 = new JsonParser::Node(""),
                     *child32 = new JsonParser::Node(""),
                     *child33 = new JsonParser::Node(""),
                     *child34 = new JsonParser::Node("");
    ...
    JsonParser::Node *child41 = new JsonParser::Node(""),
                     *child42 = new JsonParser::Node(""),
                     *child43 = new JsonParser::Node("");
    JsonParser::Node *child411 = new JsonParser::Node(""),
                     *child412 = new JsonParser::Node("");
    ...
    JsonParser::Node *child421 = new JsonParser::Node(""),
                     *child422 = new JsonParser::Node("");
    ...
    JsonParser::Node *child431 = new JsonParser::Node(""),
                     *child432 = new JsonParser::Node("");
    ...
    JsonParser::Node *child51 = new JsonParser::Node(""),
                     *child52 = new JsonParser::Node("");
    JsonParser::Node *child511 = new JsonParser::Node("name"),
                     *child512 = new JsonParser::Node("age");
    ...
    JsonParser::Node *child521 = new JsonParser::Node("name"),
                     *child522 = new JsonParser::Node("age");
    ...
    ASSERT_EQ(
        root.Str(),
        R"({"color_list":["red","green","blue"],"num_list":[123,456,789],"mix_list":["red",456,null,true],"array_list":[[12,23],[34,45],[56,67]],"object_list":[{"name":"Tanaka","age":26},{"name":"Suzuki","age":32}]})");
}
...
TEST(JsonParserTest, NodeHappyTest16) {
    JsonParser::Node root("");
    for (int i = 0; i < 3; ++i) {
        JsonParser::Node *child = new JsonParser::Node("");
        child->SetNumber(std::to_string(i));
        root.AppendArray(child);
    }
    for (int i = 0; i < root.ArraySize(); ++i) {
        ASSERT_EQ(root[i].Value(), std::to_string(i));
    }
}

TEST(JsonParserTest, NodeHappyTest17) {
    JsonParser::Node root(""), *child1 = new JsonParser::Node("id"),
                               *child2 = new JsonParser::Node("name");
    root.AppendObject(child1);
    root.AppendObject(child2);
    std::vector<std::string> key_list = root.KeyList();
    ASSERT_EQ(key_list[0], "id");
    ASSERT_EQ(key_list[1], "name");
}
